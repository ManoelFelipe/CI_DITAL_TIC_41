...
if {$IMPLEMENTATION eq "behavioral"} {
    vlog -work work ../rtl/behavioral/multiplex_N_1.v
} elseif {$IMPLEMENTATION eq "dataflow"} {
    vlog -work work ../rtl/dataflow/multiplex_N_1.v
} elseif {$IMPLEMENTATION eq "structural"} {
    vlog -work work ../rtl/structural/multiplex_N_1.v
} else {
    echo "IMPLEMENTATION invalido: $IMPLEMENTATION"
    return
}
vlog -work work ../tb/tb_multiplex_N_1.v
