...
if {$IMPLEMENTATION eq "behavioral"} {
    vlog -work work ../rtl/behavioral/demux_1_N.v
} elseif {$IMPLEMENTATION eq "dataflow"} {
    vlog -work work ../rtl/dataflow/demux_1_N.v
} elseif {$IMPLEMENTATION eq "structural"} {
    vlog -work work ../rtl/structural/demux_1_N.v
} else {
    echo "IMPLEMENTATION invalido: $IMPLEMENTATION"
    return
}
vlog -work work ../tb/tb_demux_1_N.v
