...
if {$IMPLEMENTATION eq "behavioral"} {
    vlog -work work ../rtl/behavioral/ieee754_divider.v
} elseif {$IMPLEMENTATION eq "dataflow"} {
    vlog -work work ../rtl/dataflow/ieee754_divider.v
} elseif {$IMPLEMENTATION eq "structural"} {
    vlog -work work ../rtl/structural/ieee754_divider.v
} else {
    echo "IMPLEMENTATION invalido: $IMPLEMENTATION"
    return
}

vlog -work work ../tb/tb_ieee754_divider.v
