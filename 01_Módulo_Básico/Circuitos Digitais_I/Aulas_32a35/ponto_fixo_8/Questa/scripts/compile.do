...
if {$IMPLEMENTATION eq "behavioral"} {
    vlog -work work ../rtl/behavioral/ponto_fixo_8.v
} elseif {$IMPLEMENTATION eq "dataflow"} {
    vlog -work work ../rtl/dataflow/ponto_fixo_8.v
} elseif {$IMPLEMENTATION eq "structural"} {
    vlog -work work ../rtl/structural/ponto_fixo_8.v
} else {
    echo "IMPLEMENTATION invalido: $IMPLEMENTATION"
    return
}
vlog -work work ../tb/tb_ponto_fixo_8.v
