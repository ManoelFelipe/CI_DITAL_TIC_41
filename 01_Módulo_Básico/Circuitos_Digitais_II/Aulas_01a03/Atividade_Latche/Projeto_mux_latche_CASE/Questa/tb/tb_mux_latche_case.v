// ============================================================================
// Arquivo  : tb_mux_latche_case.v
// Autor    : Manoel Furtado
// Data     : 15/11/2025
// Ferramentas: Compatível com Quartus e Questa (Verilog 2001)
// Descrição: Testbench para verificar o funcionamento do mux_latche_case.
...
module tb_mux_latche_case;
    ...
    mux_latche_case_behavioral #(.WIDTH(WIDTH)) dut_behav (
        .sel(sel), .in0(in0), .in1(in1), .in2(in2), .in3(in3), .out(out_behav)
    );

    mux_latche_case_dataflow #(.WIDTH(WIDTH)) dut_data (
        .sel(sel), .in0(in0), .in1(in1), .in2(in2), .in3(in3), .out(out_data)
    );

    mux_latche_case_structural #(.WIDTH(WIDTH)) dut_struct (
