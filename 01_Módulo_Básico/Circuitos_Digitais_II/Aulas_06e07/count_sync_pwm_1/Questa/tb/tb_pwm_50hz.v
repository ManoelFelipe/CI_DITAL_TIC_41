...
module tb_pwm_50hz;
    ...
    // *** IMPORTANTE ***
    // Para simular 20ms reais (2.000.000 ciclos), a simulação fica MUITO LENTA.
    // Para verificar a funcionalidade rapidamente, usamos um valor reduzido (2000).
    // Para a entrega final ou síntese, o valor correto seria 2_000_000.
    localparam integer TB_COUNTER_MAX  = 2000;
    ...
    initial begin
        ...
        // Executa casos de teste para 25%, 50%, 75% e 100%
        run_case(2'b00, 25);     // Caso duty = 25%
        tabela_didatica(2'b00);  // Tabela didática para duty 25%

        run_case(2'b01, 50);     // Caso duty = 50%
        tabela_didatica(2'b01);  // Tabela didática para duty 50%

        run_case(2'b10, 75);     // Caso duty = 75%
        tabela_didatica(2'b10);  // Tabela didática para duty 75%

        run_case(2'b11, 100);    // Caso duty = 100%
        tabela_didatica(2'b11);  // Tabela didática para duty 100%
