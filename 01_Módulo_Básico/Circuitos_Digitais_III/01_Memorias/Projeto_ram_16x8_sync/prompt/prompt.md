  ...
  ```
  Projeto_ram_16x8_sync/
  ├── README.md
  ├── Quartus/
  │   └── rtl/
  │       ├── behavioral/ram_16x8_sync
  │       ├── dataflow/ram_16x8_sync
  │       └── structural/ram_16x8_sync
  └── Questa/
      ├── rtl/
      │   ├── behavioral/ram_16x8_sync
      │   ├── dataflow/ram_16x8_sync
  ...
  ```verilog
  // ============================================================================
  // Arquivo  : ram_16x8_sync  (implementação [ABORDAGEM])
  ...
  if {$IMPLEMENTATION eq "behavioral"} {
      vlog -work work ../rtl/behavioral/ram_16x8_sync
  } elseif {$IMPLEMENTATION eq "dataflow"} {
      vlog -work work ../rtl/dataflow/ram_16x8_sync
  } elseif {$IMPLEMENTATION eq "structural"} {
      vlog -work work ../rtl/structural/ram_16x8_sync
  } else {
      echo "IMPLEMENTATION invalido: $IMPLEMENTATION"
      return
  }

  vlog -work work ../tb/tb_ram_16x8_sync
  ```
