  ...
  ```
  Projeto_rom_16x8_async/
  ├── README.md
  ├── Quartus/
  │   └── rtl/
  │       ├── behavioral/rom_16x8_async
  │       ├── dataflow/rom_16x8_async
  │       └── structural/rom_16x8_async
  └── Questa/
      ├── rtl/
      │   ├── behavioral/rom_16x8_async
      │   ├── dataflow/rom_16x8_async
      │   └── structural/rom_16x8_async
      ├── tb/tb_rom_16x8_async
  ...
  ```verilog
  // ============================================================================
  // Arquivo  : rom_16x8_async  (implementação [ABORDAGEM])
  ...
  if {$IMPLEMENTATION eq "behavioral"} {
      vlog -work work ../rtl/behavioral/rom_16x8_async
  } elseif {$IMPLEMENTATION eq "dataflow"} {
      vlog -work work ../rtl/dataflow/rom_16x8_async
  } elseif {$IMPLEMENTATION eq "structural"} {
      vlog -work work ../rtl/structural/rom_16x8_async
  } else {
      echo "IMPLEMENTATION invalido: $IMPLEMENTATION"
      return
  }

  vlog -work work ../tb/tb_rom_16x8_async
  ```
