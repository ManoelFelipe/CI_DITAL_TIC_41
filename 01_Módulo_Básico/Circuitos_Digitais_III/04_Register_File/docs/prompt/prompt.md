  ...
  ```
  Projeto_regfile8x16c/
  ├── README.md
  ├── Quartus/
  │   └── rtl/
  │       ├── behavioral/regfile8x16c
  │       ├── dataflow/regfile8x16c
  │       └── structural/regfile8x16c
  └── Questa/
      ├── rtl/
      │   ├── behavioral/regfile8x16c
      │   ├── dataflow/regfile8x16c
  ...
  ```verilog
  // ============================================================================
  // Arquivo  : regfile8x16c  (implementação [ABORDAGEM])
  ...
  if {$IMPLEMENTATION eq "behavioral"} {
      vlog -work work ../rtl/behavioral/regfile8x16c
  } elseif {$IMPLEMENTATION eq "dataflow"} {
      vlog -work work ../rtl/dataflow/regfile8x16c
  } elseif {$IMPLEMENTATION eq "structural"} {
      vlog -work work ../rtl/structural/regfile8x16c
  } else {
      echo "IMPLEMENTATION invalido: $IMPLEMENTATION"
      return
  }

  vlog -work work ../tb/tb_regfile8x16c
  ```
